...
public class SuperSmartParkingBoyTest {
    @Test
    public void should_park_in_larger_available_slot_when_parking_given_first_level_capacity_is_2_having_1_parked_car_and_second_level_capacity_is_3_having_no_parked_car() {
        //given
        Car car1 = new Car();
        Car car2 = new Car();
        Car car3 = new Car();
